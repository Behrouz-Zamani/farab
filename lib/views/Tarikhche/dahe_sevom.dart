...
class DaheSevom extends StatefulWidget {
  const DaheSevom({super.key});

  @override
  State<DaheSevom> createState() => _DaheSevomState();
}

class _DaheSevomState extends State<DaheSevom> {

List<Chaharom> posted = [];
  Future getResponse() async {
    var url = "https://farab-co.ir/api/about/sevom";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('تاریخچه دهه سوم فراب'),
        centerTitle: true,
      ),
      body: Column(
        children: [
